    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stars', models.ImageField(default=0, upload_to='', verbose_name='Рейтинг')),
                ('product_reviews', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='store_app.product')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('product_comments', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='store_app.product')),
            ],
        ),
    ]
